...
| [Browser Chat Phase 1](browser-chat-phase-1/README.md) | Draft | Project-scoped browser Chat translates questions to validated DTQL and queries a versioned local Chinook IndexedDB dataset through DALgo, rendering structured rows in AG Grid. |
